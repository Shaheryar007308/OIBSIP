...
import com.example.tickit.ui.widjets.categoryIcon
...
fun ItemCard(
    ...
    var isExpand by remember(item.id) { mutableStateOf(false) }
    ...
    Card(
        ...
        Row(
            ...
            IconButton(onClick = {
                onRadioButtonClick(!item.isDone)
            }) {
                Icon(
                    imageVector = if (item.isDone) Icons.Default.Circle else Icons.Default.RadioButtonUnchecked,
